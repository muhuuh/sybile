  ...
  return (
    <main className="bg-gray-100 min-h-screen p-8">
      <div className="text-center">
        <h1 className="text-2xl font-bold text-gray-900 mb-4 tracking-wider">
      ...
      <section className="max-w-6xl mx-auto bg-white rounded-lg shadow-md p-8 mt-20">
        <p className="text-center pb-4 px-24">
          Upload list of addresses and receive your sybile attacker analysis
          including all sybile addresses and clusters with custom confidence
          band, interactive visualisation, and more.
        </p>
        <div
          {...getRootProps()}
